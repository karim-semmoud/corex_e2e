    ...
    >
      ...
      >
        <.demo_section
          ...
          code={Demo.api_pause_client_binding_code()}
        >
        ...
        <.demo_section
          ...
          code_tabs={[
            %{value: "heex", label: "Heex", language: :heex, code: Demo.api_pause_client_js_heex()},
            %{value: "js", label: "JS", language: :js, code: Demo.api_pause_client_js_js()},
            %{value: "ts", label: "TS", language: :javascript, code: Demo.api_pause_client_js_ts()}
          ]}
        >
        ...
        <.demo_section
          ...
          title="Pause (Server)"
          code_tabs={[
            %{value: "heex", label: "Heex", language: :heex, code: Demo.api_pause_server_heex()},
            %{
              value: "elixir",
              label: "Elixir",
              language: :elixir,
              code: Demo.api_pause_server_elixir()
            }
          ]}
        >
        ...
        <.demo_section
          ...
          code={Demo.api_resume_client_binding_code()}
        >
        ...
        <.demo_section
          ...
          code_tabs={[
            %{value: "heex", label: "Heex", language: :heex, code: Demo.api_resume_client_js_heex()},
            %{value: "js", label: "JS", language: :js, code: Demo.api_resume_client_js_js()},
            %{value: "ts", label: "TS", language: :javascript, code: Demo.api_resume_client_js_ts()}
          ]}
        >
        ...
        <.demo_section
          ...
          title="Resume (Server)"
          code_tabs={[
            %{value: "heex", label: "Heex", language: :heex, code: Demo.api_resume_server_heex()},
            %{
              value: "elixir",
              label: "Elixir",
              language: :elixir,
              code: Demo.api_resume_server_elixir()
            }
          ]}
        >
        ...
        <.demo_section
          ...
          code={Demo.api_toggle_client_binding_code()}
        >
        ...
        <.demo_section
          ...
          code_tabs={[
            %{value: "heex", label: "Heex", language: :heex, code: Demo.api_toggle_client_js_heex()},
            %{value: "js", label: "JS", language: :js, code: Demo.api_toggle_client_js_js()},
            %{value: "ts", label: "TS", language: :javascript, code: Demo.api_toggle_client_js_ts()}
          ]}
        >
        ...
        <.demo_section
          ...
          code_tabs={[
            %{value: "heex", label: "Heex", language: :heex, code: Demo.api_toggle_server_heex()},
            %{
              value: "elixir",
              label: "Elixir",
              language: :elixir,
              code: Demo.api_toggle_server_elixir()
            }
          ]}
        >
